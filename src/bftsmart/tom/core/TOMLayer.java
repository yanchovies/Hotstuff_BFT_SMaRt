...
public final class TOMLayer extends Thread implements RequestReceiver {
    ...
    public Backup backup; // Acceptor role of the PaW algorithm
    ...
    private boolean alreadySendKeys = false;
    ...
    public TOMLayer(ExecutionManager manager,
        ...
        try {
            ...
            System.out.println("Failed to get message digest engine"+e);
        }

        try {
            this.engine = TOMUtil.getSigEngine();
        } catch (Exception e) {
            System.out.println("Failed to get signature engine"+e);
        }
    ...
    public SignedObject sign(Serializable obj) {
        try {
            ...
            System.out.println("Failed to sign object"+e);
            return null;
        }
    }
    ...
    public boolean verifySignature(SignedObject so, int sender) {
        try {
            ...
            System.out.println("Failed to verify object signature"+e);
        }
        return false;
    }
...
//            }
            ...
            if ((execManager.getCurrentLeader() == this.controller.getStaticConf().getProcessId()) && //I'm the leader
                ...
                execManager.getPrimary().startConsensus(execId, createPropose(dec));
            }
        }
        System.out.println("TOMLayer stopped.");
    }
    ...
    public TOMMessage[] checkProposedValue(byte[] proposedValue, boolean addToClientManager) {
        ...
        try{
                ...
                for (TOMMessage request : requests) {
                    ...
                    verifierExecutor.submit(() -> {
                        try {
                            ...
                            System.out.println("Error while validating requests"+e);
                            if (Thread.holdsLock(clientsManager.getClientsLock())) clientsManager.getClientsLock().unlock();
            ...
            System.out.println("Failed to check proposed value"+e);
            if (Thread.holdsLock(clientsManager.getClientsLock())) clientsManager.getClientsLock().unlock();
