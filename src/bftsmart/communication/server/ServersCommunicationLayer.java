    ...
    public void joinViewReceived() {
        ...
        for (int i = 0; i < pendingConn.size(); i++) {
            ...
            try {
                ...
                System.out.println("Failed to estabilish connection to " + pc.remoteId+e);
            }
        }
    ...
    public void run() {
        while (doWork) {
            try {
                ...
                System.out.println("Problem during thread execution"+ex);
            }
        }
        ...
        try {
            ...
            System.out.println("Failed to close server socket"+ex);
        }

        System.out.println("ServerCommunicationLayer stopped.");
    }
