...
public class ServerConnection {
    ...
    public ServerConnection(ServerViewController controller, Socket socket, int remoteId,
        ...
        if (isToConnect()) {
            ...
            try {
                ...
                System.out.println("Failed to connect to replica"+ex);
        ...
        if (this.socket != null) {
            try {
                ...
                System.out.println("Error creating connection to "+remoteId+ex);
            }
        }
    ...
    protected void reconnect(Socket newSocket) {
        ...
        if (socket == null || !socket.isConnected()) {
            ...
            try {
                ...
                System.out.println("Impossible to reconnect to replica " + remoteId + ": " + ex.getMessage());
                //ex.printStackTrace();
            }
            ...
            if (socket != null) {
                try {
                    ...
                    System.out.println("Failed to authenticate to replica"+ex);
                }
            }
        }
    ...
    public void authenticateAndEstablishAuthKey() {
        ...
        try {
            ...
            System.out.println("Failed to create secret key"+ex);
        }
    }
    ...
    protected class ReceiverThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("Failed to get MAC vector object"+ex);
            }
            ...
            while (doWork) {
                if (socket != null && socketInStream != null) {
                    try {
                        ...
                        System.out.println("Failed to deserialize message"+ex);
                    } catch (IOException ex) {
                        //ex.printStackTrace();
                        if (doWork) {
                            closeSocket();
