...
public class ConsensusMessage extends SystemMessage {
    ...
    public String getPaxosVerboseType() {
        if (paxosType== MessageFactory.PREPARE)
            return "PREPARE";
        else if (paxosType== MessageFactory.PREPAREVOTE)
            return "PREPAREVOTE";
        else if (paxosType== MessageFactory.PRECOMMIT)
            return "PRECOMMIT";
        else if (paxosType== MessageFactory.PRECOMMITVOTE)
            return "PRECOMMITVOTE";
        else if (paxosType== MessageFactory.COMMIT)
            return "COMMIT";
        else if (paxosType== MessageFactory.COMMITVOTE)
            return "COMMITVOTE";
